...
public class UserCenterRequest {
	...
	public String getFollowedListById(String memberId, String viewerId,
			int limit, int pageNum) throws IOException, TimeoutException {
		return null;
	}
	...
	public String getFollowingListById(String memberId, String viewerId,
			int limit, int pageNum) throws IOException, TimeoutException {
		return null;
	}
	...
	public String getLoginResponse(String email, String password)
		...
		HttpResponse httpResponse = baseRequest
				.post("/APIV2/Login.php", params);
	...
	public String getFansRequest(String memberID, String viewerID,
			String limit, String page) throws IOException, TimeoutException {
		baseRequest = new BasicHttpClient(url);
		baseRequest.setConnectionTimeout(2000);
		ParameterMap params = baseRequest.newParams().add("memberID", memberID)
				.add("viewerID", viewerID).add("limit", limit)
				.add("page", page);
		HttpResponse httpResponse = baseRequest.post(
				"/APIV2/getFollowedList.php", params);
		return httpResponse.getBodyAsString();
	}
	...
	public String getFollowingRequest(String memberID, String viewerID,
			String limit, String page) throws IOException, TimeoutException {
		baseRequest = new BasicHttpClient(url);
		baseRequest.setConnectionTimeout(2000);
		ParameterMap params = baseRequest.newParams().add("memberID", memberID)
				.add("viewerID", viewerID).add("limit", limit)
				.add("page", page);
		HttpResponse httpResponse = baseRequest.post("/getFollowingList.php",
				params);
		return httpResponse.getBodyAsString();
	}
	...
	public String getBlockedRequest(String memberID, String limit, String page)
		...
		HttpResponse httpResponse = baseRequest.post(
				"/APIV2/getBlockedList.php", params);
		return httpResponse.getBodyAsString();
	}

	// get user reply list
	// http://54.213.167.5/APIV2/getUpdates.php?memberID=25
	public String getUserUpdate(String memberId) throws IOException,
			TimeoutException {
		baseRequest = new BasicHttpClient(url);
		baseRequest.setConnectionTimeout(2000);
		ParameterMap params = baseRequest.newParams().add("memberID", memberId);
		HttpResponse httpResponse = baseRequest.post("/APIV2/getUpdates.php",
				params);
		return httpResponse.getBodyAsString();
	}
	...
	public String getUserPostThreadList(String memberID, String page,
			String limit) throws IOException, TimeoutException {
		baseRequest = new BasicHttpClient(url);
		baseRequest.setConnectionTimeout(2000);
		ParameterMap params = baseRequest.newParams().add("memberID", memberID)
				.add("limit", limit).add("page", page);
	...
	public String searchByAccountName(String accountName, int viewerID) {
		...
		HttpResponse httpResponse = baseRequest.post(
				"/APIV2/searchByAccountName", params);
		return httpResponse.getBodyAsString();
	}
